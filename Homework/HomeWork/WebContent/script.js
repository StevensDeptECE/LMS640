...
xmlhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
        ...
        document.getElementById("Questions").innerHTML = myObj.question;
        document.getElementById("coursetitle").innerHTML = myObj.name;
        document.getElementById("dueDate").innerHTML = myObj.DueDate;
    }
};
xmlhttp.open("GET", "hw.json", true);
xmlhttp.send();
