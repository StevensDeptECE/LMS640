    ...
    for (var j = 1; j <= Divs.getElementsByTagName('div').length; j++) {
        ...
        if(document.getElementById("type_row"+i).value == "Drag and Drop"){
            ...
            for(var i = 0; i < dragDropOptions.length; i++){
                optionArray.push(dragDropOptions[i].innerHTML);
            }
            var operCont2 = optionArray;
            ...
            for(var i = 0; i < locations.length; i++){
                ...
                locationArray.push("left:" + left.substring(0,left.indexOf("p")));
                locationArray.push(",top:" + top.substring(0,top.indexOf("p")));
                operCont3.push(locationArray);
            }
            ...
            operFinal.push("MC");
            var allChoices = [];
            for(var q = 1; q < MC_Index; q++) {
                allChoices.push(document.getElementById(q + "MC_row" + i).value);
            }
            MC_Index = 5;
            ...
            operFinal.push("MCS");
            var allChoices = [];
            for(var q = 1; q < MCS_Index; q++) {
                allChoices.push(document.getElementById(q + "MCS_row" + i).value);
            }
            MCS_Index = 5;
            operCont2 = allChoices;
            operFinal.push(operCont2);
            ...
            var allChoices = [];
            for(var q = 1; q < MCD_Index; q++) {
                allChoices.push(document.getElementById(q + "MCD_row" + i).value);
            }
            MCD_Index = 5;
            operCont2 = allChoices;
            operFinal.push(operCont2);
            ...
            operFinal.push(document.getElementById("numbersSet"+i).value);
            operFinal.push(addOn);
            ...
            newOperCont2 = newOperCont2.split(/,/g);
            ...
            operCont2 = operCont2.split(/,/g);
            operFinal.push(operCont2);
            operCont3 = document.getElementById("matchRight"+i).value;
            operCont3= operCont3.split(/,/g);
            operFinal.push(operCont3);
            operFinal.push(addOn);
            ...
            var allChoices = [];
            for(var q = 1; q < MS_Index; q++) {
                allChoices.push(document.getElementById(q + "surveyCont" + i).value);
            }
            MS_Index = 5;
            operCont2 = allChoices;
            ...
            var allChoices = [];
            for(var q = 1; q < MSC_Index; q++) {
                allChoices.push(document.getElementById(q + "surveyC" + i).value);
            }
            MSC_Index = 5;
